...
# Import the adapter layer from the plugin package
sys.path.insert(0, str(Path.home() / ".hermes" / "plugins"))
from fusion.adapters import Dispatch, dispatch as adapter_dispatch  # noqa: E402
    ...
    if not dry_run:
        ...
        try:
            ...
            _spec = _ilu.spec_from_file_location(
                "build_fusion_header",
                str(Path.home() / ".hermes" / "skills" / "autonomous-ai-agents"
                    / "fusion-orchestration" / "scripts" / "build_fusion_header.py"))
